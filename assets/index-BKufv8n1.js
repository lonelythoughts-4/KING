...
const p = {
  ...
  generateAvatarColors(t) {
    const i = t
      ...
      f = [];
    for (let h = 0; h < 5; h += 1) {
      const w = this.tintColor(n, 0.15 * h);
...
function b(t) {
  return function (i) {
    return typeof i == "function" ? T(t, i) : z(t, i);
  };
}
/**
 * @license
 ...
 */ const _ = {
  ...
  j = (t = _, e, i) => {
    ...
    if (
      (o === void 0 && globalThis.litPropertyMetadata.set(r, (o = new Map())),
      n === "setter" && ((t = Object.create(t)).wrapped = !0),
      o.set(i.name, t),
      n === "accessor")
    ) {
      const { name: s } = i;
      return {
        set(a) {
          ...
          e.set.call(this, a), this.requestUpdate(s, f, t, !0, a);
        },
        init(a) {
    ...
    if (n === "setter") {
      ...
      return function (a) {
        const f = this[s];
        e.call(this, a), this.requestUpdate(s, f, t, !0, a);
      };
    }
    ...
    typeof i == "object"
      ...
      : ((n, r, o) => {
          ...
          return (
            ...
            s ? Object.getOwnPropertyDescriptor(r, o) : void 0
          );
        })(t, e, i);
}
/**
 ...
 */ const E = M(
    class extends R {
      constructor(t) {
        if (
          (super(t),
          t.type !== U.ATTRIBUTE || t.name !== "class" || t.strings?.length > 2)
        )
          throw Error(
      ...
      update(t, [e]) {
        ...
        for (const n in e) {
          ...
          r === this.st.has(n) ||
            this.nt?.has(n) ||
            (r ? (i.add(n), this.st.add(n)) : (i.remove(n), this.st.delete(n)));
        }
        return C;
      }
    }
...
var g = function (t, e, i, n) {
  ...
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
    ...
    for (var a = t.length - 1; a >= 0; a--)
      (s = t[a]) && (o = (r < 3 ? s(o) : r > 3 ? s(e, i, o) : s(e, i)) || o);
...
d.styles = [v, A];
g([l()], d.prototype, "variant", void 0);
g([l()], d.prototype, "color", void 0);
g([l()], d.prototype, "align", void 0);
g([l()], d.prototype, "lineClamp", void 0);
d = g([b("wui-text")], d);
const G = m`
  :host {
    display: flex;
...
u.styles = [v, G];
c([l()], u.prototype, "flexDirection", void 0);
c([l()], u.prototype, "flexWrap", void 0);
c([l()], u.prototype, "flexBasis", void 0);
c([l()], u.prototype, "flexGrow", void 0);
c([l()], u.prototype, "flexShrink", void 0);
c([l()], u.prototype, "alignItems", void 0);
c([l()], u.prototype, "justifyContent", void 0);
c([l()], u.prototype, "columnGap", void 0);
c([l()], u.prototype, "rowGap", void 0);
c([l()], u.prototype, "gap", void 0);
c([l()], u.prototype, "padding", void 0);
c([l()], u.prototype, "margin", void 0);
u = c([b("wui-flex")], u);
export { p as U, E as a, b as c, M as e, R as i, l as n, U as t };
