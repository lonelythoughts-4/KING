import { i as N, a as y, b as l, r as p, n as P } from "./state-B82jP9eE.js";
import {
  M as _,
  O as j,
  q as k,
...
import { c as f, n as g } from "./index-BKufv8n1.js";
import { H as S, N as G } from "./HelpersUtil-y9fXpnp9.js";
import { e as L, n as Y } from "./ref-BPss61j8.js";
import { o as q } from "./if-defined-Crp9voik.js";
...
var W = function (s, e, t, n) {
  ...
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
    ...
    for (var a = s.length - 1; a >= 0; a--)
      (r = s[a]) && (i = (o < 3 ? r(i) : o > 3 ? r(e, t, i) : r(e, t)) || i);
...
let b = class extends y {
  ...
  async firstUpdated() {
    ...
    (this.bodyObserver = new ResizeObserver((t) => {
      const o = t?.[0]?.contentBoxSize?.[0]?.inlineSize;
      (this.iframe.style.height = `${T}px`),
        (e.style.height = `${T}px`),
        j.state.enableEmbedded
          ...
          : ((this.iframe.style.width = `${D}px`),
            (this.iframe.style.left = `calc(50% - ${D / 2}px)`),
            (this.iframe.style.top = `calc(50% - ${T / 2}px + ${Q / 2}px)`),
...
b.styles = X;
W([p()], b.prototype, "ready", void 0);
b = W([f("w3m-approve-transaction-view")], b);
...
U = J([f("w3m-upgrade-wallet-view")], U);
const Z = F`
  :host {
    position: relative;
    width: 100%;
...
let c = class extends K {
  ...
  baseNameTemplate() {
    return w`<wui-text variant="paragraph-400" color="fg-200" class="base-name">
      ${C.WC_NAME_SUFFIX}
    </wui-text>`;
  }
  loadingTemplate() {
    return this.loading
      ? w`<wui-loading-spinner size="md" color="accent-100"></wui-loading-spinner>`
      : null;
  }
  errorTemplate() {
    return this.errorMessage
      ? w`<wui-text variant="tiny-500" color="error-100" class="error"
...
c.styles = [H, Z];
h([g()], c.prototype, "errorMessage", void 0);
h([g({ type: Boolean })], c.prototype, "disabled", void 0);
h([g()], c.prototype, "value", void 0);
h([g({ type: Boolean })], c.prototype, "loading", void 0);
h([g({ attribute: !1 })], c.prototype, "onKeyDown", void 0);
c = h([f("wui-ens-input")], c);
const ee = N`
  wui-flex {
    width: 100%;
  }
...
let u = class extends y {
  constructor() {
    super(),
      ...
      (this.suggestions = m.state.suggestions),
      (this.profileName = O.state.profileName),
      (this.onDebouncedNameInputChange = M.debounce((e) => {
        e.length < 4
          ? (this.error = "Name must be at least 4 characters long")
          : S.isValidReownName(e)
          ? ((this.error = ""), m.getSuggestions(e))
  ...
  submitButtonTemplate() {
    const e = this.suggestions.find(
      (n) => n.name?.split(".")?.[0] === this.name && n.registered
    );
    if (this.loading)
      return l`<wui-loading-spinner
        ...
        color="fg-200"
      ></wui-loading-spinner>`;
    const t = `${this.name}${C.WC_NAME_SUFFIX}`;
    return l`
      <wui-icon-link
        .disabled=${e}
  ...
  onNameInputChange(e) {
    const t = S.validateReownName(e.detail || "");
    (this.name = t), this.onDebouncedNameInputChange(t);
  }
  onKeyDown(e) {
    e.key.length === 1 && !S.isValidReownName(e.key) && e.preventDefault();
  }
  nameSuggestionTagTemplate(e) {
    return this.loading
      ? l`<wui-loading-spinner color="fg-200"></wui-loading-spinner>`
      : e.registered
  ...
  templateSuggestions() {
    return !this.name || this.name.length < 4 || this.error
      ? null
      : l`<wui-flex flexDirection="column" gap="xxs" alignItems="center">
  ...
  isAllowedToSubmit(e) {
    const t = e.split(".")?.[0],
      n = this.suggestions.find(
        (o) => o.name?.split(".")?.[0] === t && o.registered
      );
    return (
      !this.loading &&
      !this.error &&
  ...
  async onSubmitName(e) {
    try {
      ...
      v.sendEvent({
        ...
        properties: {
          isSmartAccount:
            x($.state.activeChain) === R.ACCOUNT_TYPES.SMART_ACCOUNT,
          ensName: e,
        },
      }),
        await m.registerName(e),
        v.sendEvent({
          type: "track",
...
u.styles = ee;
d([P()], u.prototype, "errorMessage", void 0);
d([p()], u.prototype, "name", void 0);
d([p()], u.prototype, "error", void 0);
d([p()], u.prototype, "loading", void 0);
d([p()], u.prototype, "suggestions", void 0);
d([p()], u.prototype, "profileName", void 0);
u = d([f("w3m-register-account-name-view")], u);
const te = N`
  .continue-button-container {
    width: 100%;
  }
`;
var ie = function (s, e, t, n) {
  var o = arguments.length,
    i =
      o < 3 ? e : n === null ? (n = Object.getOwnPropertyDescriptor(e, t)) : n,
    r;
...
E.styles = te;
E = ie([f("w3m-register-account-name-success-view")], E);
export {
