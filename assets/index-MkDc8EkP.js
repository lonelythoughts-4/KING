...
import { n as u, c as C } from "./index-BKufv8n1.js";
import { o as O } from "./if-defined-Crp9voik.js";
...
async function j(e) {
  ...
  try {
    ...
    if (t && e) {
      if ((c.isTelegram() || (o = T()), o))
        d.setSocialWindow(o, w.state.activeChain);
      ...
      if (!n)
        throw (
          (o?.close(), new Error("Could not fetch the social redirect uri"))
        );
      if ((o && (o.location.href = n), c.isTelegram())) {
        E.setTelegramSocialProvider(e);
...
var S = function (e, t, o, i) {
  var n = arguments.length,
    r =
      n < 3 ? t : i === null ? (i = Object.getOwnPropertyDescriptor(t, o)) : i,
    a;
...
l.styles = [b, R, W];
p([u()], l.prototype, "logo", void 0);
p([u()], l.prototype, "name", void 0);
p([u()], l.prototype, "align", void 0);
p([u()], l.prototype, "tabIdx", void 0);
p([u({ type: Boolean })], l.prototype, "disabled", void 0);
l = p([C("wui-list-social")], l);
export { F as e };
