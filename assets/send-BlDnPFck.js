import { i as T, n as N, r as c, a as R, b as u } from "./state-B82jP9eE.js";
import {
  h as B,
  f as v,
  C as q,
...
import { c as w, n as p, U as y } from "./index-BKufv8n1.js";
import "./index-C9zBBVHU.js";
import "./index-A0M8I9iF.js";
import { e as M, n as Y } from "./ref-BPss61j8.js";
import "./index-D8xqqY-u.js";
import { e as Z, n as ee } from "./ref-DW5yp8T7.js";
import { n as te, s as ie } from "./ConstantsUtil-Dmg8YACJ.js";
import "./index-CuWM1KTk.js";
import "./index-DAvEXBu3.js";
import { S as K } from "./SwapController-BkGiRP5f.js";
import "./index-DlUxI7NJ.js";
import "./index-B0OJo7jk.js";
import "./index-BzVmVC7w.js";
import "./index-Ds6Cdb4C.js";
import { o as ne } from "./if-defined-DAH1OjUw.js";
...
let $ = class extends R {
  constructor() {
    super(...arguments),
      ...
      (this.instructionElementRef = M()),
      (this.instructionHidden = !!this.value),
      (this.pasting = !1),
      (this.onDebouncedSearch = B.debounce(async (e) => {
        if (!e.length) {
        ...
        try {
          const r = await q.getEnsAddress(e);
          if (r) {
            l.setReceiverProfileName(e), l.setReceiverAddress(r);
            const t = await q.getEnsAvatar(e);
...
$.styles = re;
j([N()], $.prototype, "value", void 0);
j([c()], $.prototype, "instructionHidden", void 0);
j([c()], $.prototype, "pasting", void 0);
$ = j([w("w3m-input-address")], $);
const oe = z`
  :host {
    position: relative;
...
A.styles = [W, V, oe];
_([p({ type: Boolean })], A.prototype, "disabled", void 0);
_([p({ type: String })], A.prototype, "value", void 0);
_([p({ type: String })], A.prototype, "placeholder", void 0);
A = _([w("wui-input-amount")], A);
const se = T`
  :host {
    width: 100%;
    height: 100px;
  ...
  sendValueTemplate() {
    if (this.token && this.sendTokenAmount) {
      ...
      return u`<wui-text class="totalValue" variant="small-400" color="fg-200"
        >${
          i ? `$${F.formatNumberToLocalString(i, 2)}` : "Incorrect value"
        }</wui-text
      >`;
    }
    return null;
...
S.styles = se;
H([N({ type: Object })], S.prototype, "token", void 0);
H([N({ type: Number })], S.prototype, "sendTokenAmount", void 0);
S = H([w("w3m-input-token")], S);
const ae = T`
  :host {
    display: block;
  }
...
let f = class extends R {
  constructor() {
    super(),
      ...
      this.token && (this.fetchBalances(), this.fetchNetworkPrice()),
  ...
  onButtonClick() {
    m.push("WalletSendPreview");
  }
  getMessage() {
    (this.message = "Preview Send"),
      this.receiverAddress &&
        !B.isAddress(this.receiverAddress, v.state.activeChain) &&
...
f.styles = ae;
k([c()], f.prototype, "token", void 0);
k([c()], f.prototype, "sendTokenAmount", void 0);
k([c()], f.prototype, "receiverAddress", void 0);
k([c()], f.prototype, "receiverProfileName", void 0);
k([c()], f.prototype, "loading", void 0);
k([c()], f.prototype, "message", void 0);
f = k([w("w3m-wallet-send-view")], f);
const le = T`
  .contentContainer {
    height: 440px;
    overflow: scroll;
...
let x = class extends R {
  ...
  templateTokens() {
    return (
      (this.tokens = this.tokenBalances?.filter(
        (e) => e.chainId === v.state.activeCaipNetwork?.caipNetworkId
      )),
      this.search
  ...
  handleTokenClick(e) {
    l.setToken(e), l.setTokenAmount(void 0), m.goBack();
  }
};
x.styles = le;
I([c()], x.prototype, "tokenBalances", void 0);
I([c()], x.prototype, "tokens", void 0);
I([c()], x.prototype, "filteredTokens", void 0);
I([c()], x.prototype, "search", void 0);
x = I([w("w3m-wallet-send-select-token-view")], x);
const ue = z`
  :host {
    display: flex;
...
let b = class extends U {
  ...
  render() {
    return h`<wui-text variant="large-500" color="fg-100">${
      this.text
    }</wui-text>
      ${this.imageTemplate()}`;
  }
  imageTemplate() {
    return this.isAddress
      ? h`<wui-avatar address=${this.address} .imageSrc=${this.imageSrc}></wui-avatar>`
      : this.imageSrc
      ? h`<wui-image src=${this.imageSrc}></wui-image>`
      : h`<wui-icon size="inherit" color="fg-200" name="networkPlaceholder"></wui-icon>`;
  }
};
b.styles = [W, V, ue];
E([p()], b.prototype, "text", void 0);
E([p()], b.prototype, "address", void 0);
E([p()], b.prototype, "imageSrc", void 0);
E([p({ type: Boolean })], b.prototype, "isAddress", void 0);
b = E([w("wui-preview-item")], b);
const ce = z`
  :host {
    display: flex;
...
let C = class extends U {
  ...
  templateContent() {
    return this.imageSrc
      ? h`<wui-image src=${this.imageSrc} alt=${this.textTitle}></wui-image>`
      : this.textValue
      ? h` <wui-text variant="paragraph-400" color="fg-100"> ${this.textValue} </wui-text>`
      : h`<wui-icon size="inherit" color="fg-200" name="networkPlaceholder"></wui-icon>`;
  }
};
C.styles = [W, V, ce];
O([p()], C.prototype, "imageSrc", void 0);
O([p()], C.prototype, "textTitle", void 0);
O([p()], C.prototype, "textValue", void 0);
C = O([w("wui-list-content")], C);
const de = T`
  :host {
    display: flex;
    width: auto;
...
let P = class extends R {
  ...
  onNetworkClick(e) {
    e && m.push("Networks", { network: e });
  }
};
P.styles = de;
L([N()], P.prototype, "receiverAddress", void 0);
L([N({ type: Object })], P.prototype, "caipNetwork", void 0);
P = L([w("w3m-wallet-send-details")], P);
const pe = T`
  wui-avatar,
  wui-image {
    display: ruby;
...
let d = class extends R {
      ...
      <wui-flex gap="xs" flexDirection="column" .padding=${[
        ...
        <wui-flex alignItems="center" justifyContent="space-between">
          ...
          <wui-preview-item
            text="${
              this.sendTokenAmount
                ? y.roundNumber(this.sendTokenAmount, 6, 5)
                : "unknown"
            } ${this.token?.symbol}"
            .imageSrc=${this.token?.iconUrl}
          ></wui-preview-item>
  ...
  async onSendClick() {
    ...
    try {
      await l.sendToken(),
        D.showSuccess("Transaction started"),
        m.replace("Account");
    } catch (e) {
      D.showError("Failed to send transaction. Please try again."),
        console.error(
      ...
      J.sendEvent({
        ...
        properties: {
          message: i,
          isSmartAccount:
            Q(v.state.activeChain) === X.ACCOUNT_TYPES.SMART_ACCOUNT,
          token: this.token?.symbol || "",
          amount: this.sendTokenAmount,
          network: v.state.activeCaipNetwork?.caipNetworkId || "",
        },
      });
    }
  }
...
d.styles = pe;
g([c()], d.prototype, "token", void 0);
g([c()], d.prototype, "sendTokenAmount", void 0);
g([c()], d.prototype, "receiverAddress", void 0);
g([c()], d.prototype, "receiverProfileName", void 0);
g([c()], d.prototype, "receiverProfileImageUrl", void 0);
g([c()], d.prototype, "caipNetwork", void 0);
g([c()], d.prototype, "loading", void 0);
d = g([w("w3m-wallet-send-preview-view")], d);
export {
  x as W3mSendSelectTokenView,
  d as W3mWalletSendPreviewView,
