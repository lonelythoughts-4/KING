...
const rt = (r) => new Y(typeof r == "string" ? r : r + "", void 0, D),
  Ot = (r, ...t) => {
    const e =
      r.length === 1
        ? r[0]
 ...
 */ const {
  ...
  V = T.trustedTypes,
  pt = V ? V.emptyScript : "",
  ut = T.reactiveElementPolyfillSupport,
  b = (r, t) => r,
  M = {
    toAttribute(r, t) {
      switch (t) {
...
let g = class extends HTMLElement {
  ...
  _$ET(t, e) {
    ...
    if (i !== void 0 && s.reflect === !0) {
      const n = (
        s.converter?.toAttribute !== void 0 ? s.converter : M
...
(g.elementStyles = []),
  ...
  ut?.({ ReactiveElement: g }),
  (T.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */ const L = globalThis,
  Z = (r) => r,
  H = L.trustedTypes,
  J = H ? H.createPolicy("lit-html", { createHTML: (r) => r }) : void 0,
  tt = "$lit$",
  ...
  y = document,
  S = () => y.createComment(""),
  w = (r) => r === null || (typeof r != "object" && typeof r != "function"),
  z = Array.isArray,
  _t = (r) => z(r) || typeof r?.[Symbol.iterator] == "function",
  R = `[ 	
\f\r]`,
  E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  K = /-->/g,
  ...
  for (let a = 0; a < e; a++) {
      ...
      (u = o.lastIndex),
        o === E
          ? p[1] === "!--"
            ...
            ? (o = F)
            : p[2] !== void 0
            ? (st.test(p[2]) && (i = RegExp("</" + p[2], "g")), (o = f))
            : p[3] !== void 0 && (o = f)
          : o === f
          ? p[0] === ">"
            ? ((o = i ?? E), (l = -1))
    ...
    n +=
      o === E
        ? h + $t
        : l >= 0
        ? (s.push(c), h.slice(0, l) + tt + h.slice(l) + _ + $)
        : h + _ + (l === -2 ? a : $);
  }
  return [
    it(
  ...
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    for (; (i = A.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        ...
        if (i.data === et) h.push({ type: 2, index: n });
        else {
          let l = -1;
...
class yt {
  ...
  u(t) {
    const {
      ...
      i = (t?.creationScope ?? y).importNode(e, !0);
    A.currentNode = i;
    let n = A.nextNode(),
      o = 0,
      a = 0,
    ...
    for (; h !== void 0; ) {
      if (o === h.index) {
        let c;
        h.type === 2
          ? (c = new P(n, n.nextSibling, this, t))
          : h.type === 1
          ? (c = new h.ctor(n, h.name, h.strings, this, t))
          : h.type === 6 && (c = new Et(n, this, t)),
          this._$AV.push(c),
          (h = s[++a]);
      }
...
class P {
    ...
    const { values: e, _$litType$: s } = t,
      i =
        typeof s == "number"
          ? this._$AC(t)
          : (s.el === void 0 &&
              (s.el = C.createElement(it(s.h, s.h[0]), this.options)),
            s);
  ...
  k(t) {
    ...
    for (const n of t)
      i === e.length
        ? e.push((s = new P(this.O(S()), this.O(S()), this, this.options)))
        : (s = e[i]),
        s._$AI(n),
        i++;
...
const bt = L.litHtmlPolyfillSupport;
bt?.(C, P), (L.litHtmlVersions ??= []).push("3.3.2");
const St = (r, t, e) => {
...
(O._$litElement$ = !0),
  (O.finalized = !0),
  B.litElementHydrateSupport?.({ LitElement: O });
const wt = B.litElementPolyfillSupport;
wt?.({ LitElement: O });
...
export { d as A, m as E, O as a, Ht as b, Ot as i, Ut as n, Tt as r };
