import { w as Q, i as kt, r as zt, a as $t, b as Y } from "./index-BXddtMGj.js";
import { n as v, c as Ot } from "./index-BKufv8n1.js";
  ...
  (e.isValid = function (r) {
    ...
    (e.getPenaltyN1 = function (r) {
      ...
      for (let B = 0; B < n; B++) {
        ...
        for (let y = 0; y < n; y++) {
          let w = r.get(B, y);
          w === h ? u++ : (u >= 5 && (s += t.N1 + (u - 5)), (h = w), (u = 1)),
            (w = r.get(y, B)),
            w === d ? a++ : (a >= 5 && (s += t.N1 + (a - 5)), (d = w), (a = 1));
        }
    ...
    (e.getPenaltyN3 = function (r) {
      ...
      for (let h = 0; h < n; h++) {
        u = a = 0;
        for (let d = 0; d < n; d++)
          (u = ((u << 1) & 2047) | r.get(h, d)),
            d >= 10 && (u === 1488 || u === 93) && s++,
            (a = ((a << 1) & 2047) | r.get(d, h)),
            d >= 10 && (a === 1488 || a === 93) && s++;
      }
      return s * t.N3;
    }),
...
(function (e) {
  const t = b,
    ...
    u = t.getBCHDigit(s);
  function a(y, w, E) {
    for (let m = 1; m <= 40; m++) if (w <= e.getCapacity(m, E, y)) return m;
  }
  function h(y, w) {
  ...
  function B(y, w) {
    for (let E = 1; E <= 40; E++)
      if (d(y, E) <= e.getCapacity(E, w, r.MIXED)) return E;
  }
  (e.from = function (w, E) {
    ...
    (e.getCapacity = function (w, E, m) {
      ...
      typeof m > "u" && (m = r.BYTE);
      const p = t.getSymbolTotalCodewords(w),
...
const ut = b,
  Lt = 1335,
  Xt = 21522,
  yt = ut.getBCHDigit(Lt);
Pt.getEncodedBits = function (t, i) {
  const o = (t.bit << 3) | i;
  let r = o << 10;
  for (; ut.getBCHDigit(r) - yt >= 0; ) r ^= Lt << (ut.getBCHDigit(r) - yt);
  return ((o << 10) | r) ^ Xt;
};
var _t = {};
const Zt = U;
...
(function (e) {
  var t = {
    single_source_shortest_paths: function (i, o, r) {
      ...
      u.push(o, 0);
      for (var a, h, d, B, y, w, E, m, p; !u.empty(); ) {
        (a = u.pop()), (h = a.value), (B = a.cost), (y = i[h] || {});
        for (d in y)
          y.hasOwnProperty(d) &&
            ((w = y[d]),
            (E = B + w),
...
(function (e) {
  ...
  function B(g) {
    const l = d(s.NUMERIC, t.NUMERIC, g),
      f = d(s.ALPHANUMERIC, t.ALPHANUMERIC, g);
    let c, C;
    return (
      u.isKanjiModeEnabled()
        ? ((c = d(s.BYTE, t.BYTE, g)), (C = d(s.KANJI, t.KANJI, g)))
        : ((c = d(s.BYTE_KANJI, t.BYTE, g)), (C = [])),
      l
        .concat(f, c, C)
        .sort(function (I, N) {
  ...
  function w(g) {
    return g.reduce(function (l, f) {
      ...
      return c && c.mode === f.mode
        ? ((l[l.length - 1].data += f.data), l)
        : (l.push(f), l);
    }, []);
  }
  function E(g) {
    ...
    for (let f = 0; f < g.length; f++) {
      ...
      switch (c.mode) {
        ...
        case t.ALPHANUMERIC:
          ...
          break;
        case t.KANJI:
          l.push([c, { data: c.data, mode: t.BYTE, length: h(c.data) }]);
          break;
        case t.BYTE:
          l.push([{ data: c.data, mode: t.BYTE, length: h(c.data) }]);
      }
    }
    return l;
  }
  function m(g, l) {
    ...
    for (let A = 0; A < g.length; A++) {
      ...
      for (let _ = 0; _ < I.length; _++) {
        const S = I[_],
          O = "" + A + _;
        N.push(O), (f[O] = { node: S, lastCount: 0 }), (c[O] = {});
        for (let et = 0; et < C.length; et++) {
          const R = C[et];
          f[R] && f[R].node.mode === S.mode
            ? ((c[R][O] =
                y(f[R].lastCount + S.length, S.mode) -
                y(f[R].lastCount, S.mode)),
              (f[R].lastCount += S.length))
            : (f[R] && (f[R].lastCount = S.length),
              (c[R][O] =
                y(S.length, S.mode) + 4 + t.getCharCountIndicator(S.mode, l)));
        }
      }
      C = N;
    }
    for (let A = 0; A < C.length; A++) c[C[A]].end = 0;
  ...
  (e.fromArray = function (l) {
    ...
    (e.fromString = function (l, f) {
      const c = B(l, u.isKanjiModeEnabled()),
        C = E(c),
        A = m(C, f),
        I = a.find_path(A.map, "start", "end"),
        N = [];
      for (let _ = 1; _ < I.length - 1; _++) N.push(A.table[I[_]].node);
...
function Ie(e, t, i) {
  ...
  i.forEach(function (a) {
    o.put(a.mode.bit, 4),
      o.put(a.getLength(), pe.getCharCountIndicator(a.mode, e)),
      a.write(o);
  });
...
function be(e, t, i) {
  ...
  let c = 0,
    ...
    A;
  for (C = 0; C < g; C++)
    for (A = 0; A < s; A++) C < m[A].length && (f[c++] = m[A][C]);
  for (C = 0; C < y; C++) for (A = 0; A < s; A++) f[c++] = p[A][C];
  return f;
}
function Ne(e, t, i, o) {
  let r;
  if (Array.isArray(e)) r = ot.fromArray(e);
    ...
    let h = t;
    if (!h) {
      const d = ot.rawSplit(e);
      h = q.getBestVersionForData(d, i);
    }
    r = ot.fromString(e, h || 40);
    ...
    (e.qrToImageData = function (o, r, n) {
      ...
      for (let y = 0; y < h; y++)
        for (let w = 0; w < h; w++) {
          let E = (y * h + w) * 4,
            m = n.color.light;
          if (y >= d && w >= d && y < h - d && w < h - d) {
            const p = Math.floor((y - d) / a),
              g = Math.floor((w - d) / a);
            m = B[u[p * s + g] ? 1 : 0];
          }
...
(function (e) {
  ...
  (e.render = function (n, s, u) {
    ...
    typeof a > "u" && (!s || !s.getContext) && ((a = s), (s = void 0)),
      s || (h = o()),
      (a = t.getOptions(a));
    const d = t.getImageWidth(n.modules.size, a),
      B = h.getContext("2d"),
      y = B.createImageData(d, d);
    return (
      t.qrToImageData(y.data, n, a), i(B, h, d), B.putImageData(y, 0, 0), h
    );
  }),
    (e.renderToDataURL = function (n, s, u) {
      ...
      typeof a > "u" && (!s || !s.getContext) && ((a = s), (s = void 0)),
        a || (a = {});
      const h = e.render(n, s, a),
        d = a.type || "image/png",
        B = a.rendererOpts || {};
      return h.toDataURL(d, B.quality);
    });
})(vt);
var Ut = {};
const Te = mt;
...
function Le(e, t) {
  const i = Array.prototype.slice.call(
      K.create(e, { errorCorrectionLevel: t }).modules.data,
      0
    ),
    o = Math.sqrt(i.length);
  return i.reduce(
    (r, n, s) => (s % o === 0 ? r.push([n]) : r[r.length - 1].push(n)) && r,
    []
  );
}
const _e = {
    generate({ uri: e, size: t, logoSize: i, dotColor: o = "#141414" }) {
      ...
      return (
        w.forEach(([m, p]) => {
          E[m] ? E[m]?.push(p) : (E[m] = [p]);
        }),
        Object.entries(E)
          .map(([m, p]) => {
            const g = p.filter((l) => p.every((f) => !at(l, f, a)));
            return [Number(m), g];
          })
          .forEach(([m, p]) => {
            p.forEach((g) => {
        ...
        Object.entries(E)
          .filter(([m, p]) => p.length > 1)
          .map(([m, p]) => {
            const g = p.filter((l) => p.some((f) => at(l, f, a)));
            return [Number(m), g];
          })
          .map(([m, p]) => {
            p.sort((l, f) => (l < f ? -1 : 1));
...
var L = function (e, t, i, o) {
  var r = arguments.length,
    n =
      r < 3 ? t : o === null ? (o = Object.getOwnPropertyDescriptor(t, i)) : o,
    s;
...
let T = class extends $t {
  ...
  templateVisual() {
    return this.imageSrc
      ? Y`<wui-image src=${this.imageSrc} alt=${
          this.alt ?? "logo"
        }></wui-image>`
      : this.farcaster
      ? Y`<wui-icon
...
T.styles = [zt, De];
L([v()], T.prototype, "uri", void 0);
L([v({ type: Number })], T.prototype, "size", void 0);
L([v()], T.prototype, "theme", void 0);
L([v()], T.prototype, "imageSrc", void 0);
L([v()], T.prototype, "alt", void 0);
L([v()], T.prototype, "color", void 0);
L([v({ type: Boolean })], T.prototype, "arenaClear", void 0);
L([v({ type: Boolean })], T.prototype, "farcaster", void 0);
T = L([Ot("wui-qr-code")], T);
