...
import { n as t, c as x, U as b } from "./index-BKufv8n1.js";
...
var u = function (a, o, r, i) {
  ...
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
    ...
    for (var s = a.length - 1; s >= 0; s--)
      (c = a[s]) && (e = (l < 3 ? c(e) : l > 3 ? c(o, r, e) : c(o, r)) || e);
        ...
        <wui-flex gap="s" alignItems="center">
          ...
          <wui-flex flexDirection="column" justifyContent="spaceBetween">
            ...
            <wui-text variant="small-400" color="fg-200">
              ${w.formatNumberToLocalString(this.tokenAmount, 4)} ${
      this.tokenCurrency
    }
            </wui-text>
          </wui-flex>
...
let d = class extends g {
  ...
  visualTemplate() {
    ...
    if (this.address) {
      ...
      const o = b.generateAvatarColors(this.address);
      return (
        (this.style.cssText += `
 ${o}`),
        null
